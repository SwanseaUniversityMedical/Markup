...
$(document).ready(function () {
    ...
    $('#variable-dropdown').change(function () {
        /*
        Show variable fields based on dropdown selection
        */
        if ($(this).val() == 'text') {
    ...
    $('#add-variable').click(function () {
        /*
        Add variable for use in sentence template
        */
        let variable = {
        ...
        if (variable.type == 'text') {
            variable.values = inputParser.getTextValues(variable);
        } else {
            variable.values = inputParser.getNumericValues(variable);
        }
...
const form = {
    ...
    bindEvents() {
        ...
        $('.added-element').click(function () {
            ...
            if (type == 'variable') {
                this.variables.splice(existingVariables.indexOf(text), 1);
                this.existingVariables.splice(existingVariables.indexOf(text), 1);
            } else {
                this.templates.splice(templates.indexOf(text), 1);
            }
